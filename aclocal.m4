dnl $XTermId: aclocal.m4,v 1.385 2014/12/22 21:38:37 tom Exp $
dnl
dnl ---------------------------------------------------------------------------
dnl
...
dnl ---------------------------------------------------------------------------
dnl CF_TTY_GROUP version: 8 updated: 2012/10/04 20:12:20
dnl ------------
...
dnl ---------------------------------------------------------------------------
dnl CF_WITH_APP_CLASS version: 2 updated: 2012/10/04 04:29:52
dnl -----------------
...
if test "x$cf_use_man2html" = xyes
then
	MAN2HTML_NOTE=""
	CF_PATH_SYNTAX(cf_man2html)
	cat >>$MAN2HTML_TEMP <<-CF_EOF
	tbl \${ROOT}.\${TYPE} | nroff -\${MACS} | $cf_man2html 
CF_EOF
elif test "x$GROFF_PATH" != "xno"
then
	MAN2HTML_NOTE=""
	cat >>$MAN2HTML_TEMP <<-CF_EOF
	tbl \${ROOT}.\${TYPE} | $GROFF_PATH -P -o0 -I\${ROOT}_ -Thtml -\${MACS}
CF_EOF
else
	MAN2HTML_NOTE="#"
fi
...
dnl ---------------------------------------------------------------------------
dnl CF_WITH_PCRE version: 10 updated: 2012/10/04 20:12:20
dnl ------------
...
dnl ---------------------------------------------------------------------------
dnl CF_XBOOL_RESULT version: 2 updated: 2012/10/04 06:57:36
dnl ---------------
